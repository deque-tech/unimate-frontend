...
const Dashboard = () => {
    ...
    const getGenderedUsers = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/gendered-users`, {
    ...
    const getMajorFilteredUsers = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/majored-users`, {
                params: {
    ...
    const getEthnicityFilteredUsers = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/ethnicity-users`, {
                params: {
    ...
    const updateMatches = async (matchedUserId) => {
        try {
            await axios.put(`${API_BASE_URL}/addmatch`, {
                userId,
                matchedUserId
            })
            getUser()
